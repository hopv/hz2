...
Section repeat.
  ...
  Variable FPrepeat_q0_0 : 
    forall arg1: ((nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))) -> ((nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))) -> (nat -> dom o))), forall arg2: (nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))), forall arg3: (nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))), forall arg4: nat, ((repeat_q0_0  arg1 arg2 arg3 arg4) <-> (repeat_q0_0gen  repeat_q0_0 arg1 arg2 arg3 arg4)).
  ...
  Variable FPinput_q0_1 : 
    forall arg6: nat, forall arg7: (nat -> dom o), forall arg8: (nat -> dom o), ((input_q0_1  arg6 arg7 arg8) <-> (input_q0_1gen  input_q0_1 arg6 arg7 arg8)).
  ...
  Variable FPg_q0_1 : 
    forall arg10: ((nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))) -> ((nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))) -> (nat -> dom o))), forall arg11: (nat -> (nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o)))), forall arg12: nat, forall arg13: nat, ((g_q0_1  arg10 arg11 arg12 arg13) <-> (g_q0_1gen  g_q0_1 arg10 arg11 arg12 arg13)).
  Variable LFPg_q0_1 : 
  ...
  Variable FPrepeat_q0_1 : 
    forall arg15: (nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))), forall arg16: (nat -> ((nat -> dom o) -> ((nat -> dom o) -> dom o))), forall arg17: nat, ((repeat_q0_1  arg15 arg16 arg17) <-> (repeat_q0_1gen  repeat_q0_1 arg15 arg16 arg17)).
